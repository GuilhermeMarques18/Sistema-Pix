...
CREATE INDEX idx_chave_pix_conta_bancaria ON chave_pix (id_conta_bancaria);
...
CREATE TABLE
    transacao (
        ...
        CONSTRAINT ck_transacao_contas_diferentes CHECK (id_conta_origem <> id_conta_destino)
    );
